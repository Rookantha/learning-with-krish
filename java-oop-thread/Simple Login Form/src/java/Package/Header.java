...
public class Header extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        String gettype = request.getMethod();
        String ref = request.getHeader("referer");
        out.println("<H1>"+gettype+"</h1>");
        out.println("<H1>"+ref+"</h1>");
        
        out.println("<table border='1' align='center'><thead><th>Header Name</th><th>Header Value</th></thead>");
